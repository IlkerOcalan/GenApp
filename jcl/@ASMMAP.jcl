...
//SYSPRINT DD DUMMY
//SYSIN    DD DUMMY
//SYSUT1   DD DISP=SHR,DSN=IBMUSER.GENAPP.SOURCE(SSMAP)
...
//*
//SYSPRINT DD SYSOUT=*
//SYSLIB   DD DISP=SHR,DSN=DFH550.CICS.SDFHMAC
//         DD DISP=SHR,DSN=IBMUSER.GENAPP.SOURCE
...
//*
//SYSPRINT DD SYSOUT=*
//SYSLMOD  DD DISP=SHR,DSN=IBMUSER.GENAPP.LOAD(SSMAP)
...
//SYSUT2   DD UNIT=SYSDA,SPACE=(CYL,(10,10))
//SYSUT3   DD UNIT=SYSDA,SPACE=(CYL,(10,10))
//SYSPUNCH DD DISP=SHR,DSN=IBMUSER.GENAPP.MAPCOPY(SSMAP)
