...
//         DD DSN=DSNC10.SDSNMACS,DISP=SHR
...
//DBRMLIB  DD DSN=IBMUSER.GENAPP.DBRMLIB(&MEM),DISP=SHR
...
//SYSUT16  DD UNIT=SYSDA,SPACE=(460,(350,100))
//SYSMDECK DD SYSOUT=*
//SYSPRINT DD SYSOUT=*
//*-------------------------------------------------------------------*
...
//         DD DISP=SHR,DSN=IBMUSER.GENAPP.SOURCE(LINKPARM)
//         PEND
//*
//*
