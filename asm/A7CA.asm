           BEGIN NAME=A7CA,VERSION=&VV,AMODE=31,SHR=NONE,XCL=NONE
*          BEGIN NAME=A7CA,VERSION=R1,AMODE=31,SHR=NONE,XCL=NONE
           PRINT GEN
*
**********************COMMENTS************************************
* INITIALISE AAA FOR T2SE (COPY OF A7CO)
*
**********************COMMENTS************************************
*
* REGISTER USAGE :
...
*
 ...
 #EDO
        EXITC
FTYPE      DC    AL2(#WAARI)           RCB FILE TYPE
FID        DC    C'AA'                 RCB RECORD ID
BORD       DC    F'161909'
EORD       DC    F'162997'
           LTORG
           FINIS
